...
for N = 1:N_total
    ...
    fp_dhp_ss           = strcat("./botswana/botswana_",num2str(N, "%02d"),"/botswana_",num2str(N, "%02d"),"_dhp_",num2str(SS_Lambda*10),".mat");
    fp_dhp_spectral     = strcat("./botswana/botswana_",num2str(N, "%02d"),"/botswana_",num2str(N, "%02d"),"_dhp_0.mat");
    fp_lapsrn           = strcat("./botswana/botswana_",num2str(N, "%02d"),"/botswana_",num2str(N, "%02d"),"_lapsrn.mat");
    fp_input            = strcat("./botswana/botswana_",num2str(N, "%02d"),"/botswana_",num2str(N, "%02d"),".mat");
   ...
   % Loading all the results
    ...
    lapsrn = imresize(lapsrn, 3/4, "nearest");
    load(fp_input);
