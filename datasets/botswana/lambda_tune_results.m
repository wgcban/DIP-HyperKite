...
lambda      = [0.0, 0.2, 0.3, 0.5, 0.6, 0.8, 1.0];
SCALE       = 3;
N_patches   = 24;
...
for i =  1: 1:length(lambda)
    for n=1:N_patches
        ...
        file_name_lambda = strcat("./botswana/botswana_",num2str(n, "%02d"),"/botswana_",num2str(n, "%02d"),"_dhp_",num2str(lambda(i)*10),".mat");
...
set(gcf,...
    'PaperPosition',[-1.74 0.25 18.68 2.50],...
    'PaperSize',[15.50, 3]);
%---------------------- Saving to DropBox --------------------------------%
saveas(gcf,'/home/lidan/Dropbox/Apps/Overleaf/IEEEGR_V1/imgs/botswana_lambda.pdf')
% clc;
% close all;