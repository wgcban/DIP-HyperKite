...
for N = 1:N_total
    ...
    fp_dhp_ss           = strcat("./pavia/pavia_",num2str(N, "%02d"),"/pavia_",num2str(N, "%02d"),"_dhp_",num2str(SS_Lambda*10),".mat");
    fp_dhp_spectral     = strcat("./pavia/pavia_",num2str(N, "%02d"),"/pavia_",num2str(N, "%02d"),"_dhp_0.mat");
    fp_lapsrn           = strcat("./pavia/pavia_",num2str(N, "%02d"),"/pavia_",num2str(N, "%02d"),"_lapsrn.mat");
