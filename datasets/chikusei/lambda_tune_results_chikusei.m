...
for i =  1: 1:length(lambda)
    for n=1:N_patches
        ...
        file_name_lambda = strcat("./chikusei/chikusei_",num2str(n, "%02d"),"/chikusei_",num2str(n, "%02d"),"_dhp_",num2str(lambda(i)*10),".mat");
...
%---------------------- Saving to DropBox --------------------------------%
saveas(gcf,'/home/lidan/Dropbox/Apps/Overleaf/IEEEGR_V1/imgs/chikusei_lambda.pdf')
% clc;
% close all;